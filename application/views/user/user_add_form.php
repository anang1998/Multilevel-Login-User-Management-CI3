            ...
            <div class="col-md-4">
                ...
                <form action="" method="post">
                    <div class="form-group <?=form_error('name_nm')? 'has-error': null?>"> <!-- kondisi jika ingin eror merah -->
                        <label>Name*</label>
                        <input type="text" name="name_nm" value="<?=set_value('name_nm')?>" class="form-control">
                        <?=form_error('name_nm')?>
                    </div>
                    <div class="form-group <?=form_error('username_nm')? 'has-error': null?>">
                        <label>Username*</label>
                        <input type="text" name="username_nm" value="<?=set_value('username_nm')?>" class="form-control">
                    ...
                    <div class="form-group <?=form_error('idnumber_nm')? 'has-error': null?>">
                        ...
                        <input type="text" name="idnumber_nm" value="<?=set_value('idnumber_nm')?>" class="form-control">
                    ...
                    <div class="form-group <?=form_error('level_nm')? 'has-error': null?>">
                        ...
                        <select name="level_nm" class="form-control">
                            ...
                            <option value="1" <?=set_value('level_nm') == 1 ? "selected": null?> >Admin</option>
                            <option value="2" <?=set_value('level_nm') == 2 ? "selected": null?> >SubAdmin</option>
                        </select>
                        <?=form_error('level_nm')?>
                    </div>
